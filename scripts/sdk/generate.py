...
'''
    for family in ['tasks', 'rooms']:
        ...
        for r in ROWS:
            ...
            elif verb=='messages':decl='roomRef: string';value='{room_ref: roomRef}';result='unknown[]'
    ...
    for family in ['tasks', 'rooms']:
        ...
        for r in ROWS:
            ...
            elif verb=='messages':params='room_ref';value='{"room_ref": room_ref}'
    ...
    mcp+='_ => None, }}\n'
    mcp += "pub(super) const fn agent_argument_fields(binding: McpVerbBinding) -> Option<&'static [&'static str]> { match binding {\n"
    for r in ROWS:
        family, verb = r['name'].split('.')
        mcp += f'McpVerbBinding::{family.title()}{verb.title()} => Some(&'+json.dumps(r['mcp_fields'])+'),\n'
    mcp += '_ => None, }}\n'
    ...
    for family in ['tasks', 'rooms']:
        ...
        for row in ROWS:
            ...
            elif verb=='messages':args='room_ref: str'
