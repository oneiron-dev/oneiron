...
+ pub ( crate ) fn apply_replayed_tombstone_for_sync ( vault : & Vault , id : & crate :: entity_id :: EntityId , raw_value : & [ u8 ] ) -> Result < crate :: deletion :: ReplayedTombstoneOutcome >
+ pub ( crate ) fn clear_remat_marker_in_txn ( vault : & Vault , wtxn : & mut heed :: RwTxn < ' _ > , window_key : & str , id : & crate :: entity_id :: EntityId ) -> Result < ( ) >
+ pub ( crate ) fn clear_replay_remat_marker_in_txn ( vault : & Vault , wtxn : & mut heed :: RwTxn < ' _ > , window_key : & str , id : & crate :: entity_id :: EntityId ) -> Result < bool >
+ pub ( crate ) fn enqueue_tombstone_reassert_marker ( vault : & Vault , window_key : & str , id : & crate :: entity_id :: EntityId ) -> Result < bool >
+ pub ( crate ) fn reassert_marker_key ( window_key : & str , id : & crate :: entity_id :: EntityId ) -> String
+ pub ( crate ) fn remat_marker_entity_for_quarantine ( container : QuarantineContainer , crdt_key : & str ) -> Option < crate :: entity_id :: EntityId >
+ pub ( crate ) fn remat_marker_key ( window_key : & str , id : & crate :: entity_id :: EntityId ) -> String
+ pub ( crate ) fn set_remat_marker ( vault : & Vault , window_key : & str , id : & crate :: entity_id :: EntityId ) -> Result < ( ) >
+ pub ( crate ) fn set_remat_marker_in_txn ( vault : & Vault , wtxn : & mut heed :: RwTxn < ' _ > , window_key : & str , id : & crate :: entity_id :: EntityId ) -> Result < ( ) >
+ pub ( crate ) fn set_replay_remat_marker ( vault : & Vault , window_key : & str , id : & crate :: entity_id :: EntityId ) -> Result < ( ) >
+ pub ( crate ) fn set_replay_remat_marker_in_txn ( vault : & Vault , wtxn : & mut heed :: RwTxn < ' _ > , window_key : & str , id : & crate :: entity_id :: EntityId ) -> Result < ( ) >
+ pub ( crate ) fn unproven_remat_marker_exists_in_txn ( vault : & Vault , wtxn : & heed :: RwTxn < ' _ > , window_key : & str , id : & crate :: entity_id :: EntityId ) -> Result < bool >
- pub ( crate ) fn apply_replayed_tombstone_for_sync ( vault : & Vault , id : & crate :: types :: EntityId , raw_value : & [ u8 ] ) -> Result < crate :: deletion :: ReplayedTombstoneOutcome >
- pub ( crate ) fn clear_remat_marker_in_txn ( vault : & Vault , wtxn : & mut heed :: RwTxn < ' _ > , window_key : & str , id : & crate :: types :: EntityId ) -> Result < ( ) >
- pub ( crate ) fn clear_replay_remat_marker_in_txn ( vault : & Vault , wtxn : & mut heed :: RwTxn < ' _ > , window_key : & str , id : & crate :: types :: EntityId ) -> Result < bool >
- pub ( crate ) fn enqueue_tombstone_reassert_marker ( vault : & Vault , window_key : & str , id : & crate :: types :: EntityId ) -> Result < bool >
- pub ( crate ) fn reassert_marker_key ( window_key : & str , id : & crate :: types :: EntityId ) -> String
- pub ( crate ) fn remat_marker_entity_for_quarantine ( container : QuarantineContainer , crdt_key : & str ) -> Option < crate :: types :: EntityId >
- pub ( crate ) fn remat_marker_key ( window_key : & str , id : & crate :: types :: EntityId ) -> String
- pub ( crate ) fn set_remat_marker ( vault : & Vault , window_key : & str , id : & crate :: types :: EntityId ) -> Result < ( ) >
- pub ( crate ) fn set_remat_marker_in_txn ( vault : & Vault , wtxn : & mut heed :: RwTxn < ' _ > , window_key : & str , id : & crate :: types :: EntityId ) -> Result < ( ) >
- pub ( crate ) fn set_replay_remat_marker ( vault : & Vault , window_key : & str , id : & crate :: types :: EntityId ) -> Result < ( ) >
- pub ( crate ) fn set_replay_remat_marker_in_txn ( vault : & Vault , wtxn : & mut heed :: RwTxn < ' _ > , window_key : & str , id : & crate :: types :: EntityId ) -> Result < ( ) >
- pub ( crate ) fn unproven_remat_marker_exists_in_txn ( vault : & Vault , wtxn : & heed :: RwTxn < ' _ > , window_key : & str , id : & crate :: types :: EntityId ) -> Result < bool >
