...
public final class PdfBoxReader {
  ...
  public static void main(String[] args) {
    ...
    try (PDDocument doc = Loader.loadPDF(pdf)) {
      ...
      out(version, "pass", "pages="+doc.getNumberOfPages()+"; signatures="+sigs.size()+"; CMS signers verified="+checked+"; ByteRange covers complete file; certificate trust not evaluated");
