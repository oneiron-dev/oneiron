...
pub use companion_preset::{
    ...
    CompanionProposalCreation, CompanionSoftConfirmation, FRIEND_HANGOUT_PRESET_ID,
    HangoutProposalAssembly, OneTimeParticipantToken, ProposalCarrier, ProposalChoice, ProposalId,
    ProposalTap, TapAggregate, assemble_hangout_proposal_message, companion_solve_request,
    create_companion_proposal, friend_hangout_preset, load_companion_preset,
    opaque_proposal_message_link, ranked_authorized_common_intersection, record_proposal_tap,
    render_companion_proposal, soft_confirm_highest_common_on_home_node,
};
pub use config::{
