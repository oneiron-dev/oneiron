...
pub(crate) use self::annotation::{
    ...
    vad_annotation_claim_body, vad_annotation_claim_id, vad_annotation_delete_scope_exists_in_txn,
    vad_annotation_from_value, vad_annotation_meta_key,
};
pub use self::claim_vad::{
    CLAIM_VAD_REAPPRAISAL_PREDICATE, ClaimVadConsolidation, ClaimVadReappraisal,
    ClaimVadTurnEvidence,
};
pub(crate) use self::claim_vad::{
...
pub(crate) use self::trigger::{
    decode_entity_ref, decode_vad_delta, reject_duplicate, vad_delta_value,
