...
use crate::claim::{
    ...
    claim_evidence_admissible, claim_evidence_taint, predicate_root,
};
...
const WATERMARK_SCHEMA_VERSION_V1: u64 = 1;
const WATERMARK_SCHEMA_VERSION: u64 = 2;
...
const KEY_LAST_TURN_ID: &str = "last_turn_id";
