...
/// plane, never claims / CRDT / export / logs. Productivity band, draw = 1.
/// Byte 86 minted under the byte-space v3 rider (re-pick within 86–99 on a
...
pub const ENTITY_TYPE_SECRET_CUSTODY: u8 = 86;
