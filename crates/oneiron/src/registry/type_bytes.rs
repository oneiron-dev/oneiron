...
pub const ENTITY_TYPE_PERSON: u8 = 10;

pub const ENTITY_TYPE_RELATIONSHIP: u8 = 11;

pub const ENTITY_TYPE_EVENT: u8 = 20;

pub const ENTITY_TYPE_SKILL: u8 = 40;

pub const ENTITY_TYPE_SUMMARY: u8 = 5;

pub const ENTITY_TYPE_PLACE: u8 = 21;

pub const ENTITY_TYPE_ASSET_TEXT: u8 = 31;

pub const ENTITY_TYPE_CONVERSATION: u8 = 4;

pub const ENTITY_TYPE_ORG: u8 = 12;

pub const ENTITY_TYPE_FACET: u8 = 13;

pub const ENTITY_TYPE_WORLD: u8 = 22;

pub const ENTITY_TYPE_ASSET: u8 = 30;

pub const ENTITY_TYPE_NOTIFICATION: u8 = 42;
...
pub const ENTITY_TYPE_CODE_ARTIFACT: u8 = 105;
...
pub const ENTITY_TYPE_BLOB_ARTIFACT: u8 = 110;
...
pub const ENTITY_TYPE_NOTE: u8 = 111;
...
pub const ENTITY_TYPE_SECRET_CUSTODY: u8 = 68;
...
/// stream class.
pub const ENTITY_TYPE_IDENTITY_TOPOLOGY_EVENT: u8 = 74;
...
pub const ENTITY_TYPE_MODEL: u8 = 90;
...
/// Short-ID prefix `ck`.
pub const ENTITY_TYPE_CONNECTOR_KEY: u8 = 80;
...
pub const ENTITY_TYPE_COUNTERPARTY_CONTACT: u8 = 82;
...
pub const ENTITY_TYPE_OUTBOUND_GRANT: u8 = 83;
...
pub const ENTITY_TYPE_PERSONA_SNAPSHOT_EXPORT: u8 = 85;
...
pub const ENTITY_TYPE_COMM_RECORD: u8 = 84;
...
pub const ENTITY_TYPE_SKILL_CONTENT_ANCHOR: u8 = 93;

/// Canon reserve; no substrate exists and writes remain rejected.
pub const ENTITY_TYPE_SUSPICIOUS_WAKE: u8 = 75;
