...
pub fn input_schema(verb: &str) -> Option<serde_json::Value> {
    Some(match verb {
        ...
        "cancel" => crate::code_run::vault_read::request_schema::<TaskRequest>(),
        "describe" => crate::code_run::vault_read::request_schema::<DescribeRequest>(),
        "tasks.create" => crate::code_run::vault_read::request_schema::<TaskCreateRequest>(),
        "tasks.update" => crate::code_run::vault_read::request_schema::<TaskRequest>(),
