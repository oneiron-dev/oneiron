...
const POLICY_KEY: &[u8] = b"buffered_message_stream_policy:v1";
...
impl Vault {
    pub(super) fn buffered_message_stream_policy(&self) -> Result<MessageStreamPolicy> {
    ...
    pub fn set_buffered_message_stream_policy(
        &self,
    ...
    pub fn set_buffered_agent_message_stream_override(
        &self,
