//! Tier-A clamp, row build, fingerprint, and Vault compile pass.

use std::collections::{BTreeMap, BTreeSet};

use rmpv::Value;

use super::codec::{hash_hex, invalid_snapshot};
use super::types::{
    PERSONA_SNAPSHOT_COMPILE_STAMP_SCHEMA_VERSION, PERSONA_SNAPSHOT_NAME_PREDICATE,
    PERSONA_SNAPSHOT_ROLE_PREDICATE, PersonaSnapshotCompile, PersonaSnapshotCompileOptions,
    PersonaSnapshotCompileStamp, PersonaSnapshotRow, PersonaSnapshotRowKind, ROW_ID_HASH_CHARS,
    ROW_ID_PREFIX, TIER_A_MIN_SENSITIVITY_BAND,
};
...
pub(super) fn verify_compile_against_stamp(compile: &PersonaSnapshotCompile) -> Result<()> {
...
pub(super) fn markdown_safe_line(text: &str) -> String {
