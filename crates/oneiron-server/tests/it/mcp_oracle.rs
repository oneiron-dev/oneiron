...
mod cb_x {
    ...
    fn arm_packaging_ladder() -> PackagingLadder {
        ...
        // Raw response identity and the new typed builders are exercised with
        // injected fetch/host calls in the client package's runtime tests.
        // Counting TypeScript return annotations is not a behavior contract.
