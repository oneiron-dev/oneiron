...
use super::{
    ...
    __path_core_hydrate, __path_core_memory_timeline, __path_core_memory_verb,
    __path_core_memory_watch_disable, __path_core_memory_watch_enable,
    __path_core_memory_watch_read, __path_core_propose, __path_core_query, __path_core_run_tree,
    ...
    __path_drill_core_header, __path_end_companion_register_relationship, __path_get_canonical,
    __path_get_companion_profile, __path_get_companion_register_record, __path_get_core_dag,
    ...
    __path_lease_register, __path_lease_revoke, __path_lease_rotate,
    __path_list_core_conversation_turns, __path_list_core_conversations,
    __path_list_core_outbound_capabilities, __path_list_core_sub_sessions, __path_migrate_core_dag,
    ...
    __path_reply_in_thread, __path_resolve_core_scope, __path_retire_companion_register_record,
    ...
    CoreHydrateRequest, CoreHydrateResponse, CoreHydrateStatus, CoreListQuery, CoreMemoryChange,
    ...
    CoreMemoryVerbRequest, CoreMemoryVerbResponse, CoreMemoryWatchResponse, CoreProposeRequest,
    CoreProposeResponse, CoreQueryRequest, CoreRunTreeEvent, CoreRunTreeEventKind,
    CoreRunTreeFailure, CoreRunTreeInterventionEffect, CoreRunTreeInterventionKind,
    CoreRunTreeInterventionRequest, CoreRunTreeInterventionResponse, CoreRunTreeNode,
    CoreRunTreeQuery, CoreRunTreeRepair, CoreRunTreeResponse, CoreRunTreeStatus,
    CoreRunTreeTimestamps, CoreShortIdHydrateError, CoreShortIdHydrateErrorKind,
    CoreShortIdHydrateOutcome, CoreTextField, DagActor, DagActorClass, DagAppendRequest,
    ...
    DagSummaryResponse, DagThreadResponse, DagTurnQuery, DiscoverResponse, DiscoveredEntity,
    EdgeResult, FeatureFlags, HealthResponse, LeaseRevokeRequest, LeaseRevokeResponse,
    MemoryReasonFormat, MemoryReasonRequest, MemoryReasonResponse, MemoryReasonSessionContext,
    MemoryReasonTrace, OutboundCapabilityDiscovery, OutboundConnectorManifestSummary,
    RateLimitStatus, SearchResult, SemanticSearchRequest, SkillPackDiscovery,
    SurfaceCounterpartyPayload, SurfaceEventAckResponse, SurfaceEventActionPayload,
    SurfaceEventHandoffStatePayload, SurfaceEventRejectionResponse, SurfaceEventSourcePayload,
    SurfaceEventStatusResponse, SurfaceEventSubmitRequest, SurfaceInteractionKindPayload,
    SurfaceSourceAppPayload, TextSearchQuery, TurnVadAnnotateQuery, TurnVadAnnotateRequest,
    TurnVadAnnotateResponse, TurnVadAnnotationSource, VadPayload, VectorSearchQuery,
};
...
#[openapi(
    paths(
        ...
        core_memory_watch_read,
        core_memory_watch_enable,
        core_memory_watch_disable,
        core_memory_verb,
