...
| `src/api/esign.rs` | src | s | 1 crate-vis | — | Public session-less signing lens |
...
| `src/api/mcp_gateway/agent_verbs.rs` | src | s | 1 crate-vis | — | Generated agent verbs retain facade identity and membership gates |
