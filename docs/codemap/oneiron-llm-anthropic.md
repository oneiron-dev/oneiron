...
| `src/lib/stream.rs` | src | s | 2 struct · 4 fn | AnthropicMessagesLlmStream, AnthropicMessagesStreamAccumulator | Anthropic block-indexed SSE decoder, including thinking and tool input |
| `src/lib/tests.rs` | test | m | — | — | — |
