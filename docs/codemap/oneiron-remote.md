...
| `src/lib.rs` | src | m | 2 struct · 24 fn · 3 const · 2 re-export | OneironClient, OpenOptions | `oneiron-remote` — the shared Rust SDK backend behind the `oneiron` npm and PyPI packages (ONE-1441 WIRE-P1) |
