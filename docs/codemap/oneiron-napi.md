...
| `src/facade/client.rs` | src | s | 2 struct · 3 fn | NapiWitnessTurnInput, NativeClient | Remote-backed NativeClient SDK seam with its stamped-turn input |
| `src/facade/client/agent_verbs.rs` | src | s | 17 fn | — | — |
