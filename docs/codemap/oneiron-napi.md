...
| `src/facade/client.rs` | src | s | 2 struct · 9 fn | NapiWitnessTurnInput, NativeClient | Remote-backed NativeClient SDK seam with its stamped-turn input |
| `src/facade/convert.rs` | src | s | 14 crate-vis | — | DTO to/from engine converters |
