...
| `src/calendar/origin.rs` | src | m | 1 struct · 5 fn · 6 crate-vis | CalendarEventInput | Calendar EVENT origin union: atomic recorded provenance and source invalidation |
