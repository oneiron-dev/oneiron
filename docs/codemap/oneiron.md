...
| `src/disclosure/scope_codec.rs` | src | s | 1 struct · 1 enum · 7 fn · 2 const · 6 crate-vis | DisclosureScope, DisclosureScopeStatus | Contact clearance envelope and canonical six-axis Scope codec |
