...
| `src/connector_key/mod.rs` | src | s | 7 re-export · 7 crate-vis | — | Connector-key registry records with effector budgets for OF-277 GOV-01 |
...
| `src/self_heal/healer_host.rs` | src | m | 5 struct · 2 enum · 9 fn | HealerDeployment, HealerProposalRecord, HealerRegistration, HealerRunReceipt, PatchPullRequest, ProposalBurstCheck, ProposalState | External healer capability, durable propose receipts, and human-only PR release |
...
| `src/sync/quota.rs` | src | m | 5 struct · 3 enum · 7 fn · 4 const · 8 crate-vis | AllowBlock, FederationBlockReason, FederationConnectionQuota, FederationPauseReason, FederationQuotaConfig, FederationQuotaSnapshot, MaintenanceIngestQuotaConfig, MaintenanceIngestQuotaSnapshot | Per-connection federation quota and maintenance ingest quota decisions |
