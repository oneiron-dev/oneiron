...
| `src/agent_dispatch/types.rs` | src | m | 7 struct · 5 enum · 6 fn · 7 const · 13 crate-vis | AgentDispatchInput, AgentDispatchOutcome, AgentDispatchStatus, AgentDispatchTarget, AgentSpawnContext, AttenuatedDispatchTarget, DispatchAgent, DispatchHealer +4 | Dispatch domain types, outcome enums, and pinned key/sentinel constants |
...
| `src/claim/mod.rs` | src | s | 8 re-export · 5 crate-vis | — | CLAIM body ABI + typed Claim API (ARCH-0003, pinned decisions D11/D17/D18) |
...
| `src/ingest/mod.rs` | src | s | 3 mod · 7 re-export · 1 crate-vis | — | Ingest source registry and source-local normalization |
...
| `src/llm/mod.rs` | src | s | 2 mod · 11 re-export · 5 crate-vis | — | Engine-facing LLM invocation seam |
...
| `src/llm/step/mod.rs` | src | s | 4 re-export · 3 crate-vis | — | LLM-5 durable-step layer: `call_as_step` BLAKE3 memoization plus the unified Budget/Consent trap record… |
...
| `src/memory/claims.rs` | src | m | 5 struct · 1 enum · 7 fn · 1 const · 6 crate-vis | ClaimInput, CommitReceipt, DeleteReceipt, MemoryReceipt, PendingWrite, SafeDeleteReason | Claim lifecycle verbs: commit/upsert/retract, safe delete, and the internal commit-decision plumbing (gate… |
...
| `src/memory/mod.rs` | src | s | 1 mod · 16 re-export · 7 crate-vis | — | BRIDGE-01 (ONE-1454): transport-agnostic memory facade |
...
| `src/provenance/mod.rs` | src | s | 3 re-export · 8 crate-vis | — | `edge.provenance` Claim module (EDGE-PROVENANCE = C, pinned decisions D10/D12/D13/D15) |
...
| `src/skill_hub/mod.rs` | src | s | 2 mod · 15 re-export · 12 crate-vis | — | Skill-hub records, provenance aliases, adapter contracts, and update gates |
...
| `src/task_verb/mod.rs` | src | s | 2 trait · 1 fn · 1 mod · 16 re-export · 7 crate-vis | Sealed, TaskAskRequest | Typed, actor-bound verbs over the Context Board TASKS section |
