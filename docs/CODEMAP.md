...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1529 | 550 | 2 |
...
| `fusion` | file+dir | 2 | s | — | — |
| `gate` | dir | 73 | m | yes | DEC-0005 Gate policy manifest resolver |
...
| `llm` | dir | 33 | m | yes | Engine-facing LLM invocation seam |
