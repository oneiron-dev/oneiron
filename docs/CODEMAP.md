...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 2087 | 707 | 6 |
...
| `claim` | dir | 39 | m | yes | CLAIM body ABI + typed Claim API (ARCH-0003, pinned decisions D11/D17/D18) |
...
| `ports` | dir | 34 | m | — | Transaction-composable storage ports |
| `ppr` | dir | 9 | m | — | — |
