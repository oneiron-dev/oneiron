...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1502 | 536 | 2 |
...
| `sync` | dir | 74 | m | — | CRDT sync layer for Oneiron |
