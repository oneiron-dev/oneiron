...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1568 | 553 | 2 |
...
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 198 | 76 | 0 |
...
| `federation` | dir | 12 | m | — | Federation grant record substrate |
...
| `maintain` | dir | 7 | m | — | — |
| `memory` | dir | 57 | m | yes | BRIDGE-01 (ONE-1454): transport-agnostic memory facade |
...
| `origin` | dir | 38 | m | yes | Vault-as-origin serving plane (ARCH-0068 Phase A) |
...
| `sync` | dir | 80 | m | — | CRDT sync layer for Oneiron |
...
| `runtime` | dir | 6 | m | — |
| `server` | dir | 9 | m | Sync server state and maintenance jobs, split by concern |
