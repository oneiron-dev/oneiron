...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1535 | 542 | 2 |
...
| `origin` | dir | 40 | m | yes | Vault-as-origin serving plane (ARCH-0068 Phase A) |
