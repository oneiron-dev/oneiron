...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1512 | 537 | 2 |
...
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 193 | 76 | 0 |
...
| `failure_ladder` | dir | 10 | s | yes | ONE-1887 failure ladder: classify → bounded retry → healer slot → surface |
...
| `tokenizer` | file | 1 | s | — | — |
| `vault` | dir | 16 | m | yes | Top-level `Vault` API: the crate's main entry point for all LMDB-backed entity / vector / edge / text /… |
