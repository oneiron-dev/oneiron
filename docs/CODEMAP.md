...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1542 | 548 | 2 |
...
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 194 | 76 | 0 |
...
| `federation` | dir | 11 | m | — | Federation grant record substrate |
