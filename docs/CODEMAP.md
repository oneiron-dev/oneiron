...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 2071 | 711 | 9 |
...
| `skill` | dir | 12 | m | yes | SKILL entity: lifecycle machine, governance tier, canonical identity, codec, and Vault doors |
...
| `skill_reliability` | dir | 11 | m | yes | ARCH-0053 §5 skill reliability (SK-05, ONE-1738): the Beta(α, β) posterior that decides which skills load… |
