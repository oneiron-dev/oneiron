...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1522 | 549 | 2 |
...
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 190 | 75 | 0 |
...
| `runtime` | dir | 6 | m | — |
| `server` | dir | 7 | s | Sync server state and maintenance jobs, split by concern |
