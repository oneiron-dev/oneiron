...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1715 | 605 | 4 |
...
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 197 | 74 | 0 |
...
| `edit_distance` | file+dir | 66 | m | yes | ED-00 (ARCH-0056 §2–3): the proposal-artifact substrate the edit-distance feedback loop replays, plus the… |
...
| `ingest` | dir | 32 | m | — | Ingest source registry and source-local normalization |
...
| `llm` | dir | 45 | m | — | Engine-facing LLM invocation seam |
...
| `serialize` | dir | 22 | m | — | Context-pack serialization |
