...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1581 | 556 | 2 |
...
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 191 | 74 | 0 |
...
| `contract_oracle` | dir | 6 | s | — | Persisted, deterministic Rust API, schema and command-output contracts |
...
| `origin` | dir | 41 | m | yes | Vault-as-origin serving plane (ARCH-0068 Phase A) |
...
| `task_verb` | dir | 31 | m | yes | Typed, actor-bound verbs over the Context Board TASKS section |
