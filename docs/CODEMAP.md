...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1541 | 541 | 1 |
...
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 189 | 72 | 0 |
...
| `claim` | dir | 27 | m | yes | CLAIM body ABI + typed Claim API (ARCH-0003, pinned decisions D11/D17/D18) |
...
| `dreamer_consolidation` | dir | 15 | m | — | Dreamer consolidation algorithm + reflection gap scan (ONE-1289, DREAM-002; DESIGN-PIN-20260710 Part A) |
...
| `fusion` | file+dir | 2 | s | — | — |
| `gate` | dir | 70 | m | yes | DEC-0005 Gate policy manifest resolver |
...
| `ingest` | dir | 14 | m | yes | Ingest source registry and source-local normalization |
