...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1576 | 561 | 3 |
...
| [oneiron-remote](codemap/oneiron-remote.md) | `oneiron-remote` — the shared Rust SDK backend behind the `oneiron` npm and PyPI packages (ONE-1441 WIRE-P1) | 6 | 8 | 0 |
| [oneiron-seal](codemap/oneiron-seal.md) | Native Rust PAdES seal and verification engine (ONE-1837) | 31 | 9 | 0 |
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 196 | 78 | 0 |
...
| `attempt_queue` | dir | 34 | m | — | Generic LMDB-backed background attempt queue |
...
| `code_sandbox` | dir | 22 | m | — | Sandbox boundary contract for code-mode execution |
...
| `context_board` | dir | 42 | m | — | Typed Context Board render projections |
| `context_pack` | dir | 20 | m | — | Context-pack assembly: retrieval results in, a hydrated, validated, budget-clamped pack out |
...
| `dreamer_consolidation` | dir | 28 | m | yes | Dreamer consolidation algorithm + reflection gap scan (ONE-1289, DREAM-002; DESIGN-PIN-20260710 Part A) |
...
| `ingest` | dir | 11 | m | — | Ingest source registry and source-local normalization |
...
| `llm` | dir | 33 | m | — | Engine-facing LLM invocation seam |
...
| `maintain` | dir | 7 | m | — | — |
| `memory` | dir | 54 | m | yes | BRIDGE-01 (ONE-1454): transport-agnostic memory facade |
| `note` | file+dir | 19 | m | yes | Attributed NOTE records: public opinions, actor-private diaries and plugin namespaces |
...
| `sync` | dir | 79 | m | — | CRDT sync layer for Oneiron |
...
| `api` | dir | 134 | m | HTTP query routes for web dashboard access |
