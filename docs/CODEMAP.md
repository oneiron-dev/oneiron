...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1563 | 564 | 2 |
...
| `skill_hub` | dir | 27 | m | yes | Skill-hub records, provenance aliases, adapter contracts, and update gates |
