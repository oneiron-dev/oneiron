...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1956 | 664 | 6 |
...
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 233 | 95 | 1 |
...
| `authority` | dir | 69 | m | yes | AUTHORITY_LOG record substrate |
...
| `edit_distance` | file+dir | 61 | m | — | ED-00 (ARCH-0056 §2–3): the proposal-artifact substrate the edit-distance feedback loop replays, plus the… |
...
| `maintain` | dir | 7 | m | — | — |
| `memory` | dir | 71 | L | yes | BRIDGE-01 (ONE-1454): transport-agnostic memory facade |
...
| `task_verb` | dir | 51 | m | yes | Typed, actor-bound verbs over the Context Board TASKS section |
...
| `api` | dir | 158 | L | HTTP query routes for web dashboard access |
