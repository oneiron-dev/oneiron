...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1569 | 562 | 2 |
...
| `authority` | dir | 60 | m | yes | AUTHORITY_LOG record substrate |
...
| `context_board` | dir | 34 | m | — | Typed Context Board render projections |
...
| `federation` | dir | 15 | m | yes | Federation grant record substrate |
| `feedback` | dir | 6 | m | — | Engine feedback channel: bundle wire contract, consent, dispatch, export |
| `fusion` | file+dir | 2 | s | — | — |
| `gate` | dir | 69 | m | yes | DEC-0005 Gate policy manifest resolver |
...
| `llm` | dir | 34 | m | yes | Engine-facing LLM invocation seam |
...
| `recovery` | file+dir | 3 | m | — | Canonical recovery artifact loader shell |
...
| `sync` | dir | 75 | m | — | CRDT sync layer for Oneiron |
...
| `task_verb` | dir | 35 | m | — | Typed, actor-bound verbs over the Context Board TASKS section |
...
| `api` | dir | 133 | m | HTTP query routes for web dashboard access |
...
| `runtime` | dir | 6 | m | — |
| `server` | dir | 8 | s | Sync server state and maintenance jobs, split by concern |
