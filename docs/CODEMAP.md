...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1609 | 563 | 1 |
...
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 193 | 75 | 0 |
...
| `calendar` | dir | 50 | m | yes | Calendar module home (CAL-00) |
...
| `claim` | dir | 19 | m | yes | CLAIM body ABI + typed Claim API (ARCH-0003, pinned decisions D11/D17/D18) |
...
| `recovery` | file+dir | 12 | m | — | Canonical Layer-1 recovery, validated rebuilds and bounded repair |
...
| `sync` | dir | 84 | m | — | CRDT sync layer for Oneiron |
...
| `tokenizer` | file | 1 | s | — | — |
| `vault` | dir | 10 | m | yes | Top-level `Vault` API: the crate's main entry point for all LMDB-backed entity / vector / edge / text /… |
