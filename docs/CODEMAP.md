...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1576 | 567 | 2 |
...
| `ingest` | dir | 24 | m | — | Ingest source registry and source-local normalization |
...
| `skill_hub` | dir | 33 | m | yes | Skill-hub records, provenance aliases, adapter contracts, and update gates |
