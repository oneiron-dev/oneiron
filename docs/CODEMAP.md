...
|---|---|---|---|---|
| [oneiron](codemap/oneiron.md) | Long-context memory engine: an LMDB vault, a write Gate, retrieval pipelines and host surfaces | 1512 | 538 | 2 |
...
| [oneiron-server](codemap/oneiron-server.md) | Oneiron CRDT sync server library | 187 | 73 | 0 |
...
| `llm` | dir | 49 | m | yes | Engine-facing LLM invocation seam |
