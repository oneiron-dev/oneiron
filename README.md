...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./docs/architecture-dark.svg?v=10">
  <source media="(prefers-color-scheme: light)" srcset="./docs/architecture-light.svg?v=10">
  <img alt="oneiron architecture" src="./docs/architecture-light.svg?v=10" width="700">
</picture>
...
<div align="center">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./docs/deployment-dark.svg?v=10">
  <source media="(prefers-color-scheme: light)" srcset="./docs/deployment-light.svg?v=10">
  <img alt="oneiron deployment targets" src="./docs/deployment-light.svg?v=10" width="600">
</picture>
</div>
...
<div align="center">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./docs/storage-dark.svg?v=10">
  <source media="(prefers-color-scheme: light)" srcset="./docs/storage-light.svg?v=10">
  <img alt="oneiron storage layout" src="./docs/storage-light.svg?v=10" width="700">
</picture>
</div>
