...
| D02 (G2) | Second corpus / unchanged-engine number absent | **Pending:** both exact full manifests are acquired, unchanged engine and complete SpreadsheetBench native/LO rows are pinned. Excel/FUSE/native-v2 comparisons are live. Saved-cache results cannot close this finding or enable native defaults. |
